...
let err = fs.readFileSync('mp3/pale.mp3')
 conn.sendMessage(id, err, MessageType.audio, { ptt: true, quoted: m }
}
else if (text == '.sound'){
let err = fs.readFileSync('mp3/sound.mp3')
 conn.sendMessage(id, err, MessageType.audio, { ptt: true, quoted: m }
}
else if (text == '.sound1'){
let err = fs.readFileSync('./mp3/sound1.mp3');
 conn.sendMessage(id, err, MessageType.audio, { ptt: true, quoted: m }
}
else if (text == '.sound2'){
let err = fs.readFileSync('./mp3/sound2.mp3');
 conn.sendMessage(id, err, MessageType.audio, { ptt: true, quoted: m }
}
else if (text == '.sound3'){
let err = fs.readFileSync('./mp3/sound3.mp3');
 conn.sendMessage(id, err, MessageType.audio, { ptt: true, quoted: m }
}
else if (text == '.sound4'){
let err = fs.readFileSync('./mp3/sound4.mp3');
 conn.sendMessage(id, err, MessageType.audio, { ptt: true, quoted: m }
}
else if (text == '.sound5'){
let err = fs.readFileSync('./mp3/sound5.mp3');
 conn.sendMessage(id, err, MessageType.audio, { ptt: true, quoted: m }
}
else if (text == '.sound6'){
let err = fs.readFileSync('./mp3/sound6.mp3');
 conn.sendMessage(id, err, MessageType.audio, { ptt: true, quoted: m }
}
else if (text == '.sound7'){
let err = fs.readFileSync('./mp3/sound7.mp3');
 conn.sendMessage(id, err, MessageType.audio, { ptt: true, quoted: m }
}
